...
@router.post("/tasks", response_model=task_schema.TaskCreateResponse, status_code=201)
...
@router.put(
    "/tasks/{task_id}", response_model=task_schema.TaskCreateResponse, status_code=201
)
